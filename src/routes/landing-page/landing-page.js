    ...
    onboardingItems: [
      {
        ...
        title: "Find yourself",
        content:
          "Turn your attention inwards and write your story each day like no one else can!",
      },
      {
        image: MoodImage,
        title: "Track your mood",
        content:
          "Get insight about your mood day by day and understand yourself better.",
      },
      {
  ...
  render() {
    ...
    const leftLink = !!isZero ? (
      ...
      <Button
        type="prev"
        variant="alt"
        onClick={() => this.goToPage(this.state.step - 1)}
      />
    );
    ...
    return (
      <section className="landing-page">
        ...
        <div
          className={`items pos-${step}`}
          style={{ "--cWidth": `${carouselWidth}vw` }}
        >
          <article className={`hero ${isZero}`}>
            <Swipeable className="wrapper" onSwiped={this.handleSwipe}>
              <h2 className="h1">
                The better way to keep track of your&nbsp;days.
              </h2>
              <div className="media-tablet">
                <p>
                  Shajara lets you take down your daily thoughts and mood in a
                  beautiful way. Get in touch with your personal development,
                  and read and relive your great memories!
                </p>
              </div>
              <HeroImage />
            </Swipeable>
          ...
          <div className="highlights media-tablet">
            <div className="wrapper">
              ...
              <ul className="featureList">
                ...
                <li>
                  <span role="img" aria-label="Streaks">
                    🔥
                  </span>
